...
co17(k,i,ti)$(ord(k)<> 1)     ..(vmg(k,i,ti)$(ord(k)<> 1))/(vmg('1',i,ti)+0.0000000001) =l=0.1;
**************************************************************************************
...
Vmg.lo(k,i,ti)$(ord(k)=1)=0;
Vmg.lo(k,i,ti)$(ord(k)<>1)=0.02;
...
display y_h,branch,pgg.l,qgg.l,v.l,vrms.l,snl,ilr.l,ilim.l,thdv,inlr.l,inlim.l,iim.l,ir.l;
 ...
 execute_unload "results_6mx_hpf_b-p.gdx" VRMS
    execute 'gdxxrw.exe results_6mx_hpf_b-p.gdx Var=VRMS rng=classic1!'
   execute_unload "results_6mx_hpf_b-p.gdx" Pgg
   execute 'gdxxrw.exe results_6mx_hpf_b-p.gdx Var=Pgg rng=classic2!'
   execute_unload "results_6mx_hpf_b-p.gdx" Qgg
   execute 'gdxxrw.exe results_6mx_hpf_b-p.gdx Var=Qgg rng=classic3!'
   execute_unload "results_6mx_hpf_b-p.gdx" THDv
   execute 'gdxxrw.exe results_6mx_hpf_b-p.gdx par=THDv rng=classic4!'
